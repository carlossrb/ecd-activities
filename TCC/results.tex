...
Para a rede neural, plotou-se o gráfico da relação das \textit{epochs} pela acuracia do dataset de teste e de treino. É importante salientar que o tempo total para geração e validação do modelo com 20 \textit{epochs} foi de 19 min e 35 segundos. Em comparação com os modelos de aprendizado de máquina que duraram em média 1 minuto cada.
...
Por fim, faz-se um comparativo entre a acurácia de todos os modelos para o dataset de treino.
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.72]{./figs/roc.png}
