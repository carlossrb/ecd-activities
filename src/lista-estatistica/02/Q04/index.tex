...
\begin{center}
    \begin{tikzpicture}
        ...
        \draw (9,-0.3) node [anchor=west] [font=\footnotesize]  {$z_0\approx1.96$};
        ...
        \begin{axis}[no markers,
            ...
            \addplot [fill=pagecolor!50!COLOR2, draw=none, domain=-5:-1.959963] {gauss(0,1)} \closedcycle;
            \addplot [fill=pagecolor!50!COLOR2, draw=none, domain=1.959963:5] {gauss(0,1)} \closedcycle;
        \end{axis}
    \end{tikzpicture}
\end{center}